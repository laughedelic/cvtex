...
\years{\normalsize Address:} Pyatiletok prosp. 17-1-8, 
 ...
 Plaza Campo del Principe 19, 3D, 
 Granada, 18009, Spain\\[.2cm]
\years{\normalsize Born:}  June 26, 1989 — Lugansk, USSR\\[.2cm]
\years{\normalsize Phone:} \texttt{+7-911-1297576} (Russia), \texttt{+34-693-241-418} (Spain)\\
\years{\normalsize Email:} 
%\href{mailto:aalekhin@ohnosequences.com}{aalekhin@ohnosequences.com}\\
\href{mailto:alexey.alekhin@me.com}{alexey.alekhin@me.com}\\
\years{\normalsize Urls:} 
\href{http://ohnosequences.com/aalekhin}{ohnosequences.com/aalekhin}\\
\href{https://linkedin.com/in/aalekhin}{linkedin.com/in/aalekhin}\\
\href{https://github.com/laughedelic}{github.com/laughedelic}
%\vfill
...
\years{2012–present}Marie Curie International Training Network INTERCROSSING (3 years) — Era7 Bioinformatics, Granada, Spain;\\
...
Category theory, Type theory, Functional programming, Bioinformatics, NGS data analysis, Graph databases.
...
\years{2012–present}Era7 Bioninformatics. Researcher; Category theory; Bioinformatics (NGS data); Cloud computing (Scala, AWS);\\
\years{2011–2012}Systema-Soft. Software development for the iOS mobile platform; user interface design (Objective C, Cocoa);\\
...
Scala, Haskell, Objective C/C, Bash, Python. (in descending order)
...
Source: \href{https://github.com/laughedelic/cvtex}{https://github.com/laughedelic/cvtex}
}
\end{center}
